    ...
    struct Color {
        ...
        public:
            ...
            constexpr float32_t getHue() const {
                constexpr float32_t angle60  = (60.0f  * degToRad<float32_t>);
                constexpr float32_t angle120 = (120.0f * degToRad<float32_t>);
                constexpr float32_t angle240 = (240.0f * degToRad<float32_t>);
                constexpr float32_t angle360 = (360.0f * degToRad<float32_t>);
